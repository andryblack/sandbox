...
/**
	generated by ./gen_sb_luabind_method.sh at Fri Nov 28 03:28:22 MSK 2014
*/
	...
	namespace luabind { namespace impl {
		...
		struct method_helper<void(T::*)(),base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(0)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				(stack<T*>::get(L,base+0,false)->*func)();
				return 0;
			}
		};
		...
		struct method_helper<void(T::*)()const,base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(0)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				(stack<const T*>::get(L,base+0,false)->*func)();
				return 0;
			}
		};
		...
		struct method_helper<R(T::*)(),base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(1)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				stack<R>::push(L,(stack<T*>::get(L,base+0,false)->*func)());
				return 1;
			}
		};
		...
		struct method_helper<R(T::*)()const,base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(1)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				stack<R>::push(L,(stack<const T*>::get(L,base+0,false)->*func)());
				return 1;
			}
		};
		...
		struct method_helper<void(T::*)(A1),base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(0)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				(stack<T*>::get(L,base+0,false)->*func)(stack<A1>::get(L,base+1));
				return 0;
			}
		};
		// member method void const
		...
		struct method_helper<void(T::*)(A1)const,base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(0)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				(stack<const T*>::get(L,base+0,false)->*func)(stack<A1>::get(L,base+1));
				return 0;
			}
		};
		// member method with result
		...
		struct method_helper<R(T::*)(A1),base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(1)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				stack<R>::push(L,(stack<T*>::get(L,base+0,false)->*func)(stack<A1>::get(L,base+1)));
				return 1;
			}
		};
		// member method with result const
		...
		struct method_helper<R(T::*)(A1)const,base>{
			...
			static int call( lua_State* L ) {
				LUA_CHECK_STACK(1)
				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));
				stack<R>::push(L,(stack<const T*>::get(L,base+0,false)->*func)(stack<A1>::get(L,base+1)));
				return 1;
			}
		};
