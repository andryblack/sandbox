...
echo "		template <class T,typename FuncPtr,int base=1> struct method_helper;"
...
do
	...
	echo "		template<$tmpl_args>"
	echo "		struct method_helper<void,void(*)($func_args),base>{"
	...
	echo "		struct method_helper<T,void(*)($func_args),base>{"
	echo "			typedef void (*Func)($func_args);"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(0)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	...
	echo "		struct method_helper<void,R(*)($func_args),base>{"
	echo "			typedef R (*Func)($func_args);"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(1)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	...
	echo "		struct method_helper<T,R(*)($func_args),base>{"
	echo "			typedef R (*Func)($func_args);"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(1)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	...
	echo "		template<class U,class T,$tmpl_args>"
	echo "		struct method_helper<U,void(T::*)($func_args),base>{"
	echo "			typedef void (T::*Func)($func_args);"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(0)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				(stack<U*>::get(L,base+0,false)->*func)($call1_args);"
	echo "				return 0;"
	echo "			}"
	echo "		};"
	...
	echo "		template<class U,class T,$tmpl_args>"
	echo "		struct method_helper<U,void(T::*)($func_args)const,base>{"
	echo "			typedef void (T::*Func)($func_args)const;"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(0)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				(stack<const U*>::get(L,base+0,false)->*func)($call1_args);"
	echo "				return 0;"
	echo "			}"
	echo "		};"
	
	echo "		// member method with result"
	echo "		template<class U,class T,class R,$tmpl_args>"
	echo "		struct method_helper<U,R(T::*)($func_args),base>{"
	echo "			typedef R (T::*Func)($func_args);"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(1)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				stack<R>::push(L,(stack<U*>::get(L,base+0,false)->*func)($call1_args));"
	echo "				return 1;"
	echo "			}"
	echo "		};"
	...
	echo "		template<class U,class T,class R,$tmpl_args>"
	echo "		struct method_helper<U,R(T::*)($func_args)const,base>{"
	echo "			typedef R (T::*Func)($func_args)const;"
	echo "			static int call( lua_State* L ) {"
	echo "				LUA_CHECK_STACK(1)"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				stack<R>::push(L,(stack<const U*>::get(L,base+0,false)->*func)($call1_args));"
	echo "				return 1;"
	echo "			}"
	echo "		};"
