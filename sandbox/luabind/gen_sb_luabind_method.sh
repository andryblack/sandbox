...
do
	...
	echo "			static int call( lua_State* L ) {"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				(&stack<T>::get(L,base+0)->*func)($call1_args);"
	echo "				return 0;"
	echo "			}"
	echo "		};"
	...
	echo "			static int call( lua_State* L ) {"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				(&stack<const T>::get(L,base+0)->*func)($call1_args);"
	echo "				return 0;"
	echo "			}"
	echo "		};"
	...
	echo "			static int call( lua_State* L ) {"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				stack<R>::push(L,(&stack<T>::get(L,base+0)->*func)($call1_args));"
	echo "				return 1;"
	echo "			}"
	echo "		};"
	...
	echo "			static int call( lua_State* L ) {"
	echo "				Func func = *reinterpret_cast<Func*>(lua_touserdata(L, lua_upvalueindex(1)));"
	echo "				stack<R>::push(L,(&stack<const T>::get(L,base+0)->*func)($call1_args));"
	echo "				return 1;"
	echo "			}"
	echo "		};"
